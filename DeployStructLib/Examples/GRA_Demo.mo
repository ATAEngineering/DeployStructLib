...
model GRA_Demo "Basic model of a linear array"
  extends Modelica.Icons.Example;
  parameter Real dL = 1.221e-4;
  ...
  parameter Real mastBeamHeight = 0.1016;
  parameter Real mastEI = mastBeamMatProp.E * mastBeamXProp.Iyy;
  ...
  DeployStructLib.Parts.Beam[M] mastBeam(each L = L / M, each rigid = rigid, each xprop = mastBeamXProp, each matProp = mastBeamMatProp) annotation(
  ...
  parameter DeployStructLib.Properties.BeamXProperties.RectTubeProperty mastBeamXProp(width = 0.1016, height = mastBeamHeight, t = 0.00127) annotation(
    Placement(visible = true, transformation(origin = {-22, -56}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  parameter DeployStructLib.Properties.MaterialProperties.isotropicMaterialProperty trunkBeamMatProp(alpha = damp_alpha, beta = damp_beta, E = 1.1781e15, G = 3.8443e14, rho = 1993) annotation(
  ...
  parameter DeployStructLib.Properties.MaterialProperties.isotropicMaterialProperty mastBeamMatProp(alpha = damp_alpha, beta = damp_beta, E = 1.1781e11, G = 3.8443e10, rho = 1993) annotation(
    Placement(visible = true, transformation(origin = {-22, -86}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  parameter DeployStructLib.Properties.ClothProperty clothProperty(E = 3.45e9, area_density = 1281.6 * 0.000762, beta = 0.04, nu = 0.3, thickness = 0.000762) annotation(
    Placement(visible = true, transformation(origin = {16, -86}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  DeployStructLib.Parts.Cloth.cloth clothB(M = M, N = N, P2 = {0, -w_cloth, 0}, P3 = {L_cloth, -w_cloth, 0}, P4 = {L_cloth, 0, 0}, P2_start = {0, -w_cloth, 0}, P3_start = {L, -w_cloth, 0}, P4_start = {L, 0, 0}, flat = true, clothPropsData = clothProperty, m = 1) annotation(
    Placement(visible = true, transformation(origin = {4, -14}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  DeployStructLib.Parts.Cloth.cloth clothA(M = M, N = N, P2 = {0, w_cloth, 0}, P3 = {L_cloth, w_cloth, 0}, P4 = {L_cloth, 0, 0}, P2_start = {0, w_cloth, 0}, P3_start = {L, w_cloth, 0}, P4_start = {L, 0, 0}, flat = true, clothPropsData = clothProperty, m = 1) annotation(
    Placement(visible = true, transformation(origin = {4, 46}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Mechanics.MultiBody.Parts.FixedRotation fixedrotation1A(rotationType = Modelica.Mechanics.MultiBody.Types.RotationTypes.TwoAxesVectors, n_x = {0, 1, 0}, n_y = {-1, 0, 0}) annotation(
    Placement(visible = true, transformation(origin = {-46, 32}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Mechanics.MultiBody.Parts.FixedRotation fixedrotation2A(rotationType = Modelica.Mechanics.MultiBody.Types.RotationTypes.TwoAxesVectors, n_x = {0, 1, 0}, n_y = {-1, 0, 0}) annotation(
    Placement(visible = true, transformation(origin = {54, 32}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Mechanics.MultiBody.Parts.FixedRotation fixedrotation2B(rotationType = Modelica.Mechanics.MultiBody.Types.RotationTypes.TwoAxesVectors, n_x = {0, -1, 0}, n_y = {1, 0, 0}) annotation(
  ...
  Modelica.Mechanics.MultiBody.Parts.FixedRotation fixedrotation1B(rotationType = Modelica.Mechanics.MultiBody.Types.RotationTypes.TwoAxesVectors, n_x = {0, -1, 0}, n_y = {1, 0, 0}) annotation(
...
equation
  ...
  connect(world.frame_b, fixedrotation1A.frame_a) annotation(
    Line(points = {{-56, 32}, {-70.151, 32}, {-70.151, 19.9768}, {-69.6864, 19.9768}}, color = {95, 95, 95}));
  connect(world.frame_b, fixedrotation1B.frame_a) annotation(
    Line(points = {{-70, 20}, {-56, 20}, {-56, 10}}, color = {95, 95, 95}));
  connect(fixedrotation1A.frame_b, trunkBeamA[1].frame_a) annotation(
    Line(points = {{-36, 54}, {-36, 46}, {-50, 46}, {-50, 40}}, color = {95, 95, 95}));
