...
model StretchedBlanketDemo "Example demonstrating a Cloth block being stretched length-wise between two parallel beams."
  ...
  DeployStructLib.Parts.Cloth.cloth cloth1(tri = true, clothPropsData = clothProperty, flat = true, M = M, N = N, P1 = {0, 0, 0}, P2 = {cloth_w, 0, 0}, P3 = {cloth_w, cloth_L, 0}, P4 = {0, cloth_L, 0}, P1_start = {0, 0, 0}, P2_start = {cloth_w, 0, 0}, P3_start = {cloth_w, cloth_L, 0}, P4_start = {0, cloth_L, 0}, start_angle = 0.0, P1_loc = {0, 0, 0}, tangent_vector_sideA = {0, 1, 0}, bending_vector_sideA = {0, 0, 1}, tangent_vector_sideB = {0, -1, 0}, bending_vector_sideB = {0, 0, 1}) annotation(Placement(visible = true, transformation(origin = {-19, 9}, extent = {{-38, -38}, {38, 38}}, rotation = 0)));
