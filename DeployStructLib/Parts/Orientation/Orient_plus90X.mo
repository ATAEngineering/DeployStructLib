...
model Orient_plus90X "90 degree fixed rotation of frame_b with respect to frame_a about x-axis"
...
equation
  ...
  assert(cardinality(frame_a) > 0 or cardinality(frame_b) > 0,
    "Neither connector frame_a nor frame_b of Orient_plus90X object is connected");
