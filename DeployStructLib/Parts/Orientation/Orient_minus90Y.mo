...
model Orient_minus90Y "90 degree fixed rotation of frame_b with respect to frame_a about y-axis"
  ...
  final parameter Frames.Orientation R_rel = Frames.from_nxy({0,0,1}, {0,1,0}) "Fixed rotation object from frame_a to frame_b";
...
equation
  ...
  assert(cardinality(frame_a) > 0 or cardinality(frame_b) > 0,
    "Neither connector frame_a nor frame_b of Orient_minus90Y object is connected");
