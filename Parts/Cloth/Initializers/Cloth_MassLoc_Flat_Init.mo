...
encapsulated function Cloth_MassLoc_Flat_Init
  ...
  external "C" Cloth_MassLoc_Flat_Init(M,N,P1_start,P2_start,P3_start,P4_start,M_act,isEdge,isEdgeB,debug,A) annotation(Include = "#include \"cloth_init.h\" ", Library="cloth_init");
